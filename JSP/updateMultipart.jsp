...
String fileName;
 String realPath = "C:\\Program Files\\Apache Software Foundation\\Tomcat 8.5\\webapps\\ROOT\\test"; // 저장할 디렉토리 (절대경로)
...
try {
	...
	String addressNo = multi.getParameter("addressNo");
...
//------
	...
	try{
	    ...
	    String A = "update address set user_userid = ?, addressName = ?, addressPhone = ?, addressGroup = ?, addressEmail = ?, addressText = ?, addressBirth = ?, addressImage = ?";
